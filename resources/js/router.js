...
const routes = [
    ...
    { path: '/wishlist', component: require('./components/public/wishlist').default },
    { path: '/cart', component: require('./components/public/cart').default },
    ...
    { path: '/store', component: require('./components/auth/store').default },

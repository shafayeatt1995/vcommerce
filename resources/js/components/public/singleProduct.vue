<template>
    <div v-if="!notFound">
                            ...
                            <div class="single-product-info">
                                ...
                                <div class="single-product-brand-info">
                                    <ul>
                                        ...
                                        <li>
                                            <p class="available" v-if="product.stock_status == '1'">Availability: <span class="color-green">In Stock</span></p>
                                            <p class="available" v-else>Availability: <span class="color-red">Out Of Stock</span></p>
                                        </li>
                                    </ul>
                                </div>
                                                ...
                                                <form @submit.prevent="reviewPost">
                                                    <div class="row">
                                                        <div class="form-group col-lg-4">
                                                            ...
                                                            <select id="review-stars" class="form-select form-control" v-model="review.rating" :class="{'is-invalid': form.errors.has('rating')}" required>
                                                ...
                                                <form @submit.prevent="postQna">
                                                    <div class="row">
                                                        ...
                                                        <div class="review-submit">
                                                            ...
                                                            <button type="button" class="qna-btn-fix" v-if="qnaPostLoading">
                                                                <span class="spinner-border" role="status">
                                                                    <span class="sr-only">Loading...</span>
                                                                </span>
                                                            </button>
        ...
        <div v-if="!loading" class="text-center display-block">
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            // Update Question And Answer Data
            loadQna() {
                Fire.$emit('getQna');
            },

                                    ...
                                    <div class="col-md-6">
                                        <div class="address">
                                            ...
                                            <div class="form-group mt-3">
                                                <select class="form-control form-select" v-model="form.selectAddress" required>
                                            ...
                                            <transition name="slide" v-if="addresses.length > 0">
                                                <div v-if="form.selectAddress !== null">
                                                    ...
                                                    <div class="form-group mt-2">
                                                        ...
                                                        <select class="form-control form-select" v-model="form.shippingType" id="shippingType" required>
                                    ...
                                    <div class="col-md-6">
                                        <div class="address">
                                            ...
                                            <div class="shopping-cart-personal-address mt-3">
                                                ...
                                                <label for="billingStatus">Use My Shipping Address For Billing</label>
                                            </div>
...
<script>
    ...
    export default {
        ...
        created() {
            this.$Progress.start();
            if (this.$middleware.authCheck()) {
                axios.get('api/cart/check').then(response => {
                    const exist = response.data.cartProducts.find(cartProduct => response.data.products.find(product => product.id == cartProduct.product_id));
                    if (exist == null) {
                        this.loading = false;
                        this.$Progress.finish();
                    } else {
                        this.$router.push('/cart');
                        Fire.$emit("error", "You Can't Purchase Your Own Product");
                        this.$Progress.fail();
                    }
                });
                this.getAddress();
